...
$data1 = tampildata("Select * from peminjaman");
$data2 = tampildata("Select * from user");
$id = 0;
?>
...
<img src="img/a.png" style="width:50px;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 h-50" src="https://www.pinhome.id/blog/wp-content/uploads/2022/12/tokopedia-surat.jpeg" alt="First slide">
    </div>
  </div>
  ...
  <div class="col-md-4">
    <div class="card">
      <div class="card-body">
        ...
        <h4><?php foreach ($data as $room): ?>
        <?php echo "$room[jumlah]"; ?>
        <?php endforeach; ?></h4>
        <a href="data.php" class="link">Lihat data barang</a>
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">Data barang yang di pinjam</p>
        <h4><?php foreach ($data1 as $room): ?>
        <?php echo "$room[jumlah]"; ?>
        <?php endforeach; ?></h4>
  ...
  <div class="col-md-4">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">Data user keseluruhan</p>
        <h4><?php foreach ($data2 as $room): ?>
        <?php echo "$room[id]"; ?>
        <?php endforeach; ?></h4>
        <a href="data_user.php" class="link">Lihat data user</a>
          </div>
        </div>
       </div>
     </div>
