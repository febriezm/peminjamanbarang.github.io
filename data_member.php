                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="jumbotron">
                                        <h1>Pinjam Barang</h1><hr>
                                        <form action="proses_pinjam.php" method="POST">
                                            <div class="form-group">
                                                <label for="pinjam">ID</label>
                                                <input type="text" class="form-control" name="id">
                                                <label for="pinjam">Tanggal Pinjam</label>
                                                <input type="date" class="form-control" name="tgl_pinjam">
                                                <label for="pinjam">Tanggal Kembali</label>
                                                <input type="date" class="form-control" name="tgl_kembali">
                                                <label for="pinjam">No Identitas</label>
                                                <input type="text" class="form-control" name="no_identitas">
                                                <label for="pinjam">Kode Barang</label>
                                                <div class="form-group">
                                                <select class="form-control" name="kode_barang">
                                                <option>HPPVNAE1</option>
                                                <option>MSLGTPROX</option>
                                                <option>LGTMSPAD</option>
                                                <option>LNVTH10</option>
                                                <option>APPMACM1</option>
                                                <option>LNVY520</option>
                                                </select>
                                                </div>
                                                <label for="pinjam">Jumlah</label>
                                                <input type="text" class="form-control" name="jumlah">
                                                <label for="pinjam">Keperluan</label>
